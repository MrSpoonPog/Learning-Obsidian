---
name: researcher
description: Web researcher — searches the web and synthesizes a focused, well-sourced brief. Use to verify facts before teaching them, and to scope a topic before planning a lesson.
